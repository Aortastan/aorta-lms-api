...
trait CouponTrait
{
    ...
    public function countDiscount($request, $user) {
        ...
        $sub_total = 0; // total harga paket
        $admin_fee = $this->paymentGateway->admin_fee; // biaya admin
        $final_amount = 0; // total harga akhir yang dibayar user yang sudah termasuk diskon dan biaya admin
