        ...
        try {
            ...
            if ($getLecture) {
                ...
                $lecture = [
                    ...
                    "attendance_started_at" => $getLecture->attendance_started_at,
                    "attendance_ended_at" => $getLecture->attendance_ended_at,
                    "attendance_start_duration" => $getLecture->attendance_start_duration,
                    "attendance_end_duration" => $getLecture->attendance_end_duration,
