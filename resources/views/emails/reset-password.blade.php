...
<head>
    <meta charset="UTF-8">
    <title>Reset Password AORTAEDU</title>
</head>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="vertical-align:middle;">
                                    <img
                                        src="https://aorta-edu.com/_next/static/media/logo.977180bb.png"
                                        alt="AORTAEDU"
                                        width="48"
                ...
                <tr>
                    <td style="padding:36px 32px;color:#1f2937;">
                        ...
                        <p style="margin:0 0 18px;font-size:14px;line-height:1.6;color:#4b5563;">
                            ...
                            Kami menerima permintaan untuk mereset password akun AORTAEDU Anda.
                        ...
                        <p style="margin:0 0 12px;font-size:13px;color:#6b7280;">
                            Jika tombol di atas tidak berfungsi, silakan salin dan buka link berikut:
                        </p>
                        ...
                        <p style="margin-top:24px;font-size:12px;color:#9ca3af;">
                            ...
                            Jika Anda tidak merasa melakukan permintaan reset password, silakan abaikan email ini.
                        </p>
                    </td>
                </tr>
